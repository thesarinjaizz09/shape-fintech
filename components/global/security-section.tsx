...
const SecurityTrustSection = () => {
    return (
        <div className="w-full bg-[#001f11]/70 border border-green-900/40 backdrop-blur-md shadow-inner hover:shadow-[0_0_20px_rgba(0,255,100,0.05)] rounded-sm p-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-gray-200 backdrop-blur-md shadow-lg shadow-[#E3B341]/10 hover:shadow-[#E3B341]/20 transition-all duration-300">
            {securityFeatures.map((feature, idx) => (
                <div
                    key={idx}
                    className="flex flex-row items-center justify-center p-3 bg-gradient-to-r from-emerald-500/20 to-green-800/30 border border-green-900/40 rounded-sm text-center gap-2"
                >
